...
- **Stand:** Migration inhaltlich komplett, alle Seiten DE+EN gegen live geprüft, keine offenen Fehler. **Nächster Schritt: deine finale lokale Abnahme → Cloudflare-Deploy** (zwei Domains, braucht deine Secrets). Deploy-Hinweis CSP: `img-src i.ytimg.com`, `frame-src youtube-nocookie.com explorer.ordinalsbot.com`, Pagefind lädt nur eigene Assets.

...
- **Noch offen / Rückfrage:** Vita + Kontakt rendern optisch ok (Diff 3–5 %), enthalten aber **weiterhin Gutenberg/Stackable-Markup** (nicht editierbar) → optional ebenso sauber neu bauen? Danach: vollständige lokale Abnahme → Cloudflare-Deploy (zwei Domains, deine Secrets). Deploy-Hinweis CSP: `img-src i.ytimg.com`, `frame-src youtube-nocookie.com explorer.ordinalsbot.com`, Pagefind lädt nur eigene Assets.

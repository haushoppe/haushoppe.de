...
- **Nächste Schritte (Loop):** Bild-Pipeline (Kunstwerk-Originale→webp), Visual-Portfolio-**Galerie** (`/werke`) 1:1 mit Filter/Lightbox, restliche Seiten (Vita/Kontakt/Kunst-Erwerben/Videos + NFT-Infoseiten), Kunstwerk-Detailseiten (`/portfolio/<slug>/`), **EN-Zweig** (haushoppe.art), YouTube-Facade, Ordinals. Loop läuft autonom bis vollständig lokal prüfbar oder Blocker.

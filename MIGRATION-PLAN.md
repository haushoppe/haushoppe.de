...
- **Nächste Schritte (Loop):** Kunstwerk-**Detailseiten** (`/portfolio/<slug>/`), restliche **Seiten** (Vita/Kontakt/Kunst-Erwerben/Videos + NFT-Infoseiten), **EN-Zweig** (haushoppe.art), **YouTube-Facade** (Home + Videos-Seite, Playlist), **5 Ordinals** (iframe+Link, invertierte Farben), 2 BMP-Bilder fixen, Menü/Sprachumschalter dynamisch. Loop läuft autonom bis vollständig lokal prüfbar oder Blocker (z. B. Cloudflare-Secrets).
